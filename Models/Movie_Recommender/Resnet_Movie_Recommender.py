...
def Get_ResNet_Movie_Recommender(Pretrained=False, ResNet_Version=18, Num_Classes=1000):
    """
    ...
    # Supprimer la couche fully connected (fc)
    Model = nn.Sequential(*list(Model.children())[:-1])  # Enlève la dernière couche (fc)
